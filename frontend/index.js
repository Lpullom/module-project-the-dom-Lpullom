...
function moduleProject1() {
  ...
  authorDate.textContent = `${author} in ${date || "or in an unknown date"}`
  ...
  const mumboJumbo = `We need to ${randomAdverb1} our ${randomNoun1} ${randomVerb1} in order to ${randomAdverb2} our ${randomNoun2} ${randomVerb2}.`
